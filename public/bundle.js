...
var Chomsky = exports.Chomsky = function () {
	function Chomsky(language, translationObject) {
		_classCallCheck(this, Chomsky);

		this.currentLanguage = language;
		this.translationsDictionary = _defineProperty({}, language, translationObject);
		this.changeHandlers = [];
	}

	_createClass(Chomsky, [{
		key: 'addTranslation',
		value: function addTranslation(key, language, translation) {
			// TODO: recursive
		...
		value: function resolveTranslationObject(language) {
			...
			return new Promise(function (resolve, reject) {
				if (_this2.translationFetcher && typeof _this2.translationFetcher === 'function') {
					var promise = _this2.translationFetcher(language);
					if (!promise || typeof promise.then !== 'function') {
						reject('translationFetcher should return a promise');
					}

					promise.then(function (translationObject) {
						if (translationObject) {
							resolve(translationObject);
						} else {
...
var Demo = function Demo() {
    ...
    // Greeting
    this.chomsky = new _chomsky.Chomsky('en', _en2.default);
...
},{"./chomsky":2,"./i18n/en.json":4,"./i18n/es.json":5}],4:[function(require,module,exports){
module.exports={
    "GREETING": "Hello, {name}."
}
